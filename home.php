...
<body>
        ...
        <header style="position: sticky;top:0;z-index:15000; background-color:#08083d;">
            ...
            ?>
                <nav>
                    <ul>
                         <li id ="homel"><a href="home.php">HOME</a></li>
                         <li id ="homel"><a href="Books.php">BOOKS</a></li>
                         <li id ="homel"><a href="logout.php">LOGOUT</a></li>
                         
                         <li id ="homel"><a href="feedback.php">FEEDBACK</a></li>
                    </ul>
                </nav>
                <?php
            }
                ...
                <ul>
                     ...
                     <li id="homel"><a href="login.php"><span class="glyphicon glyphicon-log-in"></span>LOGIN</a></li>
                     <li id ="homel"><a href="student_registration.php"><span class="glyphicon glyphicon-user"></span>SIGN_UP</a></li>
