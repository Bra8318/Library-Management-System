    ...
    <nav class="navbar navbar-inverse" style="background-color:#08083d;">
            <div class="navbar-header" style="padding-top: 10px;">
                ...
                if(isset($_SESSION['login_user'])){?>
                     <ul class="nav navbar-nav">
                        <li id="homel"><a href="profile.php">PROFILE</a></li>
                    </ul>

                    <ul class="nav navbar-nav navbar-right">
                    <li id="homel"><a href="profile.php">
                    ...
                    <li id="homel"><a href="logout.php"><span class="glyphicon glyphicon-log-out"> LOGOUT</span></a></li>
                    </ul>
                   <?php
                    ...
                    <li id="homel"><a href="student_login.php"><span class="glyphicon glyphicon-log-in"> LOGIN</span></a></li>
